...
?>
                ...
                <li class="cell_name name <? echo ($winner_style); ?>" title="<? echo ($r_participant_name); ?>"><a href="<? echo ($entries_link); ?>" class="name" title="<? echo ($entries_link); ?>"><? echo ($participant_name_display); ?></a></li>
				</ul>
				<div class="clear clearfix"></div>
<?php
